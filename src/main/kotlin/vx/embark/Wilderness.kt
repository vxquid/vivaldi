...
import vx.embark.ai.ProviderManager
import vx.embark.command.VivaldiCommand
import vx.embark.gameplay.GameplayManager
import vx.embark.network.BiomeRegistryInterceptor
import vx.embark.season.SeasonManager
import vx.embark.season.biome.SeasonalBiomeManager

import java.io.File
import java.util.jar.JarFile

class Wilderness : JavaPlugin() {
    ...
    companion object {
        lateinit var plugin: Wilderness
