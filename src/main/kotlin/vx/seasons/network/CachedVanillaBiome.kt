...
import vx.seasons.season.biome.BiomeColorPalette
                ...
                for (i in elements.indices) {
                    ...
                    for (season in Season.entries) {
                        ...
                        if (normalPalette != null && altPalette != null) {
                            ...
                            val normalKey = "seasons:${seasonName}_$rawName"
                            ...
                            val altKey = "seasons:${seasonName}_${rawName}_alt"
                            ...
                            for ((bpId, bp) in DynamicForestFeature.blueprints) {
                                ...
                                if (!overrideColor.isNullOrEmpty()) {
                                    ...
                                    val treeKey = "seasons:${seasonName}_${rawName}_tree_$bpId"
